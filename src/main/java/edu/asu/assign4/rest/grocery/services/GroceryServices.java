...
public interface GroceryServices {
	...
	public static GroceryServices getGroceryService() {
		try {
			final String __theServiceImpl = "edu.asu.assign4.rest.grocery.services.impl.SimpleGroceryServicesImpl";
			System.out.println("The service impl is " + __theServiceImpl);
			final Class<GroceryServices> implClass = (Class<GroceryServices>) forName(__theServiceImpl);
